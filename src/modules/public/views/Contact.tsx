...
const Contact = () => {
    ...
    return (
        <>
            {addMetaData({
                title: "Seachems Multi-trade Ventures - Contact",
                description:
            ...
            <div className="m-[0px] mx-auto mb-[34px] h-full w-11/12 overflow-hidden pt-[20px] md:w-4/5">
                ...
                <section className="mb-[28px] flex flex-col gap-2 lg:flex-row">
                    <div className="w-full lg:w-1/3">
                        <div
                            className="flex flex-col justify-between gap-3 rounded-[4px] border border-gray p-5 sm:flex-row lg:flex-col lg:gap-5 lg:p-3">
                            <div
                                className="mr-3 w-full border-b border-r border-r-white pb-5 sm:w-1/2 sm:border-b-white sm:border-r-black lg:w-full lg:border-b lg:border-b-black lg:border-r-white lg:pb-5">
                            ...
                            <div className="w-full sm:w-1/2 lg:w-full">
                                ...
                                <p className="mb-3">
                                    Send us a mail and we will contact you within 24 hours
                                </p>
                    ...
                    <div className="hidden mt-5 w-full p-0 lg:mt-0 lg:w-2/3 lg:p-5">
