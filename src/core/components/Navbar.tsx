            ...
            >
               ...
               Seachems Multi-trade Ventures
                    ...
                    <div className="flex items-center justify-between gap-3 lg:gap-5">
                        <SearchBox
                            formStyle="hidden items-center justify-between rounded-[4px] bg-[#f5f5f5] px-2 sm:hidden"
                        ...
                        <button
                            className={`${btn} relative bg-brand text-[12px] text-white`}
                            onClick={() => navigate("/quotation")}>
                            Get Quote
                            {quotedProducts?.length > 0 && (
                                <span
                                    className="absolute -top-2 right-0 h-[26px] w-[26px] rounded-full bg-green font-bold text-[18px] text-white">
